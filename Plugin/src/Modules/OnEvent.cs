...
namespace TestingLib {
    ...
    public class OnEvent {
        ...
        /// So as a hacky workaround for now, we are waiting 50 ms to make sure the game has registered that the player is on the ship.
        /// <br/><br/>
        ...
        /// </summary>
        public static event Action PlayerSpawn_50ms_delay;
        ...
        {
            PlayerSpawn?.Invoke();
            if(PlayerSpawn_50ms_delay != null) _ = Wait50ms();
        ...
        private static async Task Wait50ms() {
            await Task.Delay(20);
            PlayerSpawn_50ms_delay?.Invoke();
        }
    }
}